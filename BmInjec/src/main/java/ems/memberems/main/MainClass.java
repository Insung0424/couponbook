...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		//학번, id, 비밀번호, 이름, 나이, 성별, 전공을 배열로 저장한다
...
//		StudentAssembler assembler = new StudentAssembler();
		StudentAssembler assembler = ctx2.getBean(StudentAssembler.class);
		
		
//		StudentRegisterService registerService = assembler.getRegisterService();
		StudentRegisterService registerService = ctx2.getBean(StudentRegisterService.class);
...
//		StudentModifyService modifyService = assembler.getModifyService();
		StudentModifyService modifyService = ctx2.getBean(StudentModifyService.class);
...
//		StudentSelectService selectService = assembler.getSelectService();
		StudentSelectService selectService = ctx2.getBean(StudentSelectService.class);
...
//		StudentAllSelectService allSelectService = assembler.getAllSelectService();
		StudentAllSelectService allSelectService = ctx2.getBean(StudentAllSelectService.class);
