			...
			if(file.getSize() >0 && StringUtils.isNotBlank(file.getName())) {
				if(file.getContentType().toLowerCase().startsWith("image/")) {
				    try{
			            ...
			            String uploadPath = req.getSession().getServletContext().getRealPath("/resources/images/src"); //저장경로
			            ...
			            String fileUrl = req.getContextPath() + "/resources/images/src/" +fileName2 +fileName; //url경로
