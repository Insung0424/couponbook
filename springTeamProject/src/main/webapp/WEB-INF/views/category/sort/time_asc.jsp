...
<body id="page-top">
 ...
 <c:forEach items="${time_asc }" var="time_asc">
                    
                        <li style="list-style: none; margin: 5px; width: 30%;"
                           class="card_dis"><a>
                              <div class="card_poto">
                              <a href='/category/detail?product_id=<c:out value="${time_asc.product_id }"/>'>
                                 <img alt="noimg"
                              ...
                              <div class="card_info">
                                 ...
                                 <div class="card_title_content">
                                    ...
                                    <a class="card-link" href='/category/detail?product_id=<c:out value="${time_asc.product_id }"/>'>${time_asc.pd_name }</a>
                                 </div>
                                 <p class="card_adr">${time_asc.pd_price }</p>
                                 <p class="card_option">
                                    <c:set var="category_id" value="${time_asc.category_id }" />
