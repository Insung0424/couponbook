...
<body id="page-top">
 ...
 <c:forEach items="${price_desc }" var="price_desc">
                    
                        <li style="list-style: none; margin: 5px; width: 30%;"
                           class="card_dis"><a>
                              <div class="card_poto">
                              <a href='/category/detail?product_id=<c:out value="${price_desc.product_id }"/>'>
                                 <img alt="noimg"
                              ...
                              <div class="card_info">
                                 ...
                                 <div class="card_title_content">
                                    ...
                                    <a class="card-link" href='/category/detail?product_id=<c:out value="${price_desc.product_id }"/>'>${price_desc.pd_name }</a>
                                 </div>
                                 <p class="card_adr">${price_desc.pd_price }</p>
                                 <p class="card_option">
                                    <c:set var="category_id" value="${price_desc.category_id }" />
