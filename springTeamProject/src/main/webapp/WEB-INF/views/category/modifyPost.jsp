...
<header>
  ...
  <path fill-rule="evenodd"
	...
	<form action="/modify" method="post" enctype="multipart/form-data" name="form" onsubmit="return su()">
		<div class="container" style="margin-top: 30px;">
			<div class="row">
				<div class="col">
					<h2 style="margin-bottom: 30px;">상품정보수정</h2>
					<hr>
					<p><b>글 제목</b></p>
					<input type="text" placeholder="제목을 입력하세요" name="pd_name"
						style="width: 500px; margin-bottom: 10px;" value="${detail.pd_name }">
					<!-- file upload -->
					<!-- <p><b>상품권 사진 첨부</b></p>
					...
					<p><b>상품권 설명</b></p>
					<textarea class="form-control" id="pd_desc" name="pd_desc" rows="5" >${detail.pd_desc}</textarea>
					...
					<p><b>가격</b></p>
					<input type = "text" name="pd_price" placeholder= "가격을 입력해주세요" style="margin-bottom: 10px;" value="${detail.pd_price}"> 원
					<p><b>할인율</b></p>
					<input type = "number" name="pd_discount" placeholder= "할인율을 입력해주세요" style="margin-bottom: 10px;" value="${detail.pd_discount }"> %
					<p><b>사용처</b></p>
					<input type = "text" name="company_name" placeholder= "사용처를 입력해주세요" style="margin-bottom: 10px;" value="${detail.company_name}">
					<p><b>온라인/오프라인 구분</b></p>
					...
					<p><b>사용기한</b></p>
					<input type="date" name="pd_date" pattern="yyyy-MM-dd" style="margin-bottom: 10px;" value="${detail.pd_date }">
