...
<body>
	...
	<div class="container" style="height: 100%">
		...
		<div id="findPasswordnChage" style="display: none;">
			...
			<div class="form-group">
				<input class="btn btn-link" id="findemailNickname" type="button"
					value="이메일과 닉네임으로 비밀번호 찾기" /> &nbsp; <input class="btn btn-link"
					id="findemailPhone" type="button" value="이메일과 전화번호로 비밀번호 찾기" />
			</div>
			...
			<div id="findpasswordnick">
				...
				<form action="/find/checknicknamenemail" method="post"
					...
					<input class="form-control" type="email" name="email"
						id="passemail" style="width: 300px; margin: 0 auto;"
						placeholder="이메일 입력"><br> <input class="form-control"
						type="text" name="nickname" id="passnickname"
						style="width: 300px; margin: 0 auto;" placeholder="닉네임 입력">
					<br>
					<button class="btn btn-primary">확인</button>
					<input type="button" value="돌아가기" id="back3"
						class="btn btn-primary" />
				</form>
			</div>
			...
			<div id="findpasswordphone" style="display: none;">
				...
				<form action="/find/checkphonenemail" method="post"
					onsubmit="return checkPass2()" id="form4">
					<input class="form-control" type="email" name="email"
						id="passemail2" style="width: 300px; margin: 0 auto;"
						placeholder="이메일 입력"><br> <input class="form-control"
						type="text" id="passphone" style="width: 300px; margin: 0 auto;"
						placeholder="전화번호 입력"> <br>
					<button class="btn btn-primary">확인</button>
					<input type="button" value="돌아가기" id="back4"
						class="btn btn-primary" />
				</form>
			</div>
