...
<div>
    ...
    <table>
        ...
        <c:forEach items="${page.content}" var="goods" varStatus="status">
            <tr>
                <td><a id="" href="${pageContext.request.contextPath}/goods/"></a></td>
                <td><fmt:formatNumber value="" type="CURRENCY" currencySymbol="&yen;" maxFractionDigits="0" /></td>
...
<div>
    ...
    <table>
        ...
        <c:forEach items="${cart.cartItems}" var="cartItem" varStatus="status">
            <tr>
                <td id="itemName${status.index}"></td>
                ...
                <td id="itemQuantity${status.index}"></td>
            </tr>
        </c:forEach>
        <tr>
            <td>Total</td>
            <td id="totalPrice"><fmt:formatNumber value= type="CURRENCY" currencySymbol="&yen;" maxFractionDigits="0" /></td>
            <td></td>
        </tr>
    </table>
</div>
